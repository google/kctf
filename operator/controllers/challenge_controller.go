...
//+kubebuilder:rbac:groups=operator.kctf.dev,resources=challenges,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.kctf.dev,resources=challenges/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.kctf.dev,resources=challenges/finalizers,verbs=update
