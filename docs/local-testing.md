...
Example: If you ran the challenge sample in the `samples/apache-php` folder, specify `apache-php` as the namespace. After forwarding completes, you can access `127.0.0.1:external_port` from your browser and should see a page similar to this one: 
